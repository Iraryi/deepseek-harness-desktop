...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  'packages/bundle/full-capability-pack': { kind: 'indirect', reason: 'The bundle selects the standard preset; each mounted plugin owns its model-facing contribution.' },
  ...
  'packages/client/ui-setup-hub': { kind: 'none', reason: 'Browser-side installation surface; registers no model prompt, tool, or result.' },
  ...
  'packages/setup/protocol': { kind: 'none', reason: 'External manifest validation runs outside model request assembly and registers nothing model-facing.' },
  'packages/setup/registry': { kind: 'none', reason: 'Catalog parsing and ranking run outside model request assembly and register nothing model-facing.' },
